...
<el-container style="height:100%;">
  ...
  <el-container>
    <el-header style="text-align: left; font-size: 12px;height:64px;padding:0;">
        <i class="side-collapse" v-bind:class="[isCollapse ? 'el-icon-d-arrow-right' : 'el-icon-d-arrow-left']" v-on:click="isCollapse=!!!isCollapse"></i>
    </el-header>
